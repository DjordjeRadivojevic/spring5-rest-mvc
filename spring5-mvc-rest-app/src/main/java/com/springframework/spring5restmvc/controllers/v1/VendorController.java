...
import com.springframework.spring5restmvc.api.v1.model.VendorListDTO;
...
public class VendorController {
    ...
    @ApiOperation(value = "This returns a list of all vendors", notes = "Notes about his list of vendors")
    @GetMapping
